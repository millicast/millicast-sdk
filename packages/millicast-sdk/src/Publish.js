...
export default class Publish extends BaseWebRTC {
   ...
   * @param {Number} [options.priority] - When multiple ingest streams are provided by the customer, add the ability to specify a priority between all ingest streams. Decimal value between the range [-2^31, +2^31 - 1]. For more information, go to [docs](https://docs.dolby.io/streaming-apis/docs).
