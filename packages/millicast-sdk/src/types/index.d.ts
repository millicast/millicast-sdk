...
declare module "@millicast/sdk" {
    ...
    export class PeerConnection extends events.EventEmitter {
         ...
         */
        getRTCLocalSDP(options?: {stereo: boolean; dtx: boolean; mediaStream: MediaStream | Array<MediaStreamTrack>; codec: VideoCodec; simulcast: boolean; scalabilityMode: string; absCaptureTime: boolean; dependencyDescriptor: boolean; disableAudio: boolean; disableVideo: boolean; setSDPToPeer: boolean}): Promise<string>
        /**
