...
declare class rtcDrmEnvironments {
  ...
  baseUrl():
    ...
    | 'https://lic.test.drmtoday.com'
    | 'https://lic.drmtoday.com'
...
declare function rtcDrmFeedFrame(
  encryptedEncodedFrame: EncryptedEncodedFrame,
  controller: TransformStreamDefaultController | null,
  drmConfig: DrmConfig
): boolean
declare function rtcDrmConfigure(drmConfig: DrmConfig): void
declare function rtcDrmSetBufferSize(
  drmConfig: DrmConfig,
  bufferSizeMs: number
): void
